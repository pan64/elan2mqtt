...
class Device:
    ...
    def create(cls, url: str) -> 'Device':
        ...
        try:
            ...
            logger.error("Invalid device data format for {}: {}".format(url, str(e)))
            raise ValueError("Invalid device configuration") from e
        except Exception as e:
            logger.error("Error creating device from {}: {}".format(url, str(e)))
            raise
        self.data = info
    ...
    def _discovery_light(self) -> None:
        ddd = {}
    ...
    #
    def _discovery_thermometer(self) -> None:
        ddd = {}
    ...
    def _discovery_detector(self) -> None:
        ddd = {}
        icon = ''
    ...
    def publish(self) -> None:
        ...
        try:
            ...
            logger.error("Unexpected error publishing {}: {}".format(self.url, str(e)))
    ...
    async def process_command(self, data: str) -> None:
        ...
        try:
            ...
            logger.error("Unexpected error processing command for {}: {}".format(self.url, str(e)))
